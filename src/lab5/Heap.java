...
public class Heap<T extends Comparable<T>> {
    ...
    public T poll() {
        ...
        T firstElement = container.get(0);
        container.set(0,container.get(length-1));
        container.remove(length-1);
        heapifyDown();
        return firstElement; // replace this line with implementation
    }
